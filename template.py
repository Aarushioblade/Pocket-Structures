...
class Template(Enum):
    CORE = Card("Core", Box(health=360, starbit=120), [
        ...
        Level(2, Box(health=720, material=36, energy=144, starbit=15000, shield=360, boost=0),
              Flow(energy=+24, ), price=Box(energy=240, material=132, starbit=300), unlocked=True, effect_range=0,
              effect_flow=Flow(health=+6),
              research_cost=Box()),
    ...
    FACTORY = Card("Factory", Box(health=72), [
        Level(1, Box(health=72), Flow(material=-9, energy=-6, starbit=+7), Box(starbit=24), False,
              research_cost=Box(material=1)),
        Level(2, Box(health=78), Flow(material=-24, energy=-15, starbit=+16), Box(starbit=30), False,
              research_cost=Box(starbit=180)),
    ...
    FINALE = Card("ULTIMATE MEGASTRUCTURE", Box(health=1728), [
        Level(1, Box(health=1000, material=1728, energy=1728, shield=1728, starbit=15000),
              ...
              Flow(health=+25), Box(starbit=15000), precondition=[(BOOST, 1)])
    ], 0)
