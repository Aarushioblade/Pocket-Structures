...
class TextInfo:
    files: dict[str, str] = {
        "booster":
            ...
            "flow of any structure around it!\n"
            "\n"
            "Boosters have a very short range,\n"
            "a medium amount of health, and\n"
            "require a significant amount\n"
            "of material and energy. Despite\n"
            "this, they can be an extremely\n"
            "powerful structure if used\n"
            "strategically. Their boosting\n"
            "effect stacks, and they can even\n"
            "increase damage output!\n",

        "core":
            "The core is everything you need\n"
            "to keep your base operational.\n"
            "\n"
            "It can store a small amount of\n"
            "energy and resources, and comes\n"
            "with a mini power supply to\n"
            "start off with.\n"
            "\n"
            "It is also the only known\n"
            "structure that can store\n"
            "starbits, the rarest resource\n"
            "in the galaxy.\n"
            "\n"
            "Because of this, enemies will\n"
            "try to destroy the core. If\n"
            "they succeed, it is game over!\n",

        "enemy":
            "Not a structure, but a threat to\n"
            "your base that should be\n"
            "destroyed as soon as possible.\n"
            "\n"
            "Enemies originate from deep space\n"
            "and feed on starbits, which is\n"
            "unfortunate because the core\n"
            "is filled with them.\n"
            "\n"
            "While the core is their main\n"
            "target, they will destroy anything\n"
            "that gets in their way.\n"
            "\n"
            "As you accumulate more starbits,\n"
            "enemies will attack more\n"
            "frequently. This will even begin\n"
            "to attract enemies from the\n"
            "deeper sectors, where they are\n"
            "known to be more powerful.\n"
            "\n"
            "Keep your Core safe at all costs!\n",

        "factory":
            "Converts raw materials into the\n"
            "highly-prized resources known as\n"
            "starbits.\n"
            "\n"
            "The conversion process requires a\n"
            "medium amount of energy, and takes\n"
            "in more material than the amount\n"
            "of starbits it produces. While it\n"
            "is an expensive process, it's\n"
            "exactly why starbits are so\n"
            "valuable.\n"
            "\n"
            "Starbits are the primary currency\n"
            "for buying and upgrading your\n"
            "structures. They also raise the\n"
            "threat level of enemies, so be\n"
            "careful!\n",

        "game complete":
            "Congratulations, Builder!\n"
            "You have proven to be a master\n"
            "of all structures, and your\n"
            "quest is finally over. The\n"
        ...
        "game over":
            "Unfortunately, your base has been\n"
            "destroyed. Without a core to keep\n"
            "it functioning, you are unable to\n"
            "continue.\n"
            "\n"
            "The enemies won this time, but it\n"
            "doesn't have to be this way.\n"
            "\n"
            "Play again?\n",

        "generator":
            "A simple structure that generates\n"
            "energy for your base.\n"
            "\n"
            "As you build more structures,\n"
            "power generated by the Core will\n"
            "not be enough to meet growing\n"
            "energy demands. This is where\n"
            "building generators becomes\n"
            "essential.\n"
            "\n"
            "Generators are highly volatile,\n"
            "and as a result, have low\n"
            "structural integrity. If an\n"
            "enemy should reach an\n"
            "unprotected generator, it may\n"
            "have severe consequences on\n"
            "your base...!\n",

        "hyperbeam":
            "Fires a high-energy beam at\n"
            "enemies, dealing a tremendous\n"
            "amount of damage.\n"
            "\n"
            "The latest advances in energy\n"
            "storage and consumption have led\n"
            "to the hyperbeam, an incredibly\n"
            "powerful structure. With its high\n"
            "range and high damage output, it\n"
            "can defend any base with ease -\n"
            "as long as it remains charged.\n"
            "\n"
            "Though only for a brief moment,\n"
            "the energy needed to fire the\n"
            "hyperbeam is enormous. To account\n"
            "for these sudden drops in energy,\n"
            "it is recommended to build power\n"
            "boxes to stabilize energy flow.\n",
        ...
        "intro":
            ...
            "build the Ultimate Megastructure\n"
            "through building, selling,\n"
            "researching, and upgrading\n"
            "structures!\n"
            "\n"
            "Each structure has a unique\n"
            "purpose, and it is up to you to\n"
            "figure out how to use them.\n"
            "\n"
            "Also, enemies from deep space\n"
            "want to destroy your base for\n"
            "valuable resources, so\n"
            "defend it well.\n"
            "\n"
            "Good luck!\n",

        "laser mine":
            "Mines for raw materials using the\n"
            "latest cutting-edge technology.\n"
            "\n"
            "Laser mines lock onto passing\n"
            "asteroids and extract raw material\n"
            "from them, which can be collected\n"
            "and then stored to nearby\n"
            "structures.\n"
            "\n"
            "These structures require a high\n"
            "amount of energy, so building\n"
            "generators is recommended.\n"
            "\n"
            "The material it produces is\n"
            "commonly used in starbit\n"
            "production, though it could\n"
            "potentially be used as\n"
            "ammunition, or regeneration...\n",

        "power box":
            "Stores excess energy, which it\n"
            "can discharge later when needed.\n"
            "\n"
            "The power box has a higher\n"
            "capacity than a storage structure,\n"
            "but it is slightly weaker.\n"
            "\n"
            "When destroyed, it will attempt to\n"
            "store its energy somewhere else,\n"
            "but any excess will be lost.\n"
            "\n"
            "Researching the power box may lead\n"
            "to the development of much more\n"
            "powerful structures...\n",

        "regenerator":
            "Uses material to repair structures\n"
            "that have been damaged by enemies.\n"
            "\n"
            "Regenerators do not require power\n"
            "to operate, making them useful in\n"
            "emergency situations. They simply\n"
            "rebuild the damaged structure\n"
            "using spare materials.\n"
            "\n"
            "Regenerators are also capable of\n"
            "repairing themselves.\n",

        "shield":
            "Generates a force field that\n"
            "surrounds nearby structures,\n"
            "which protects from enemy\n"
            "attacks.\n"
            "\n"
            "When an enemy attacks a shielded\n"
            "structure, it has to break through\n"
            "that shield first before it can\n"
            "damage the building. From its\n"
            "design, a shield can completely\n"
            "protect structures from weak\n"
            "enemy attacks.\n"
            "\n"
            "While shields are more effective\n"
            "at defending than regenerators,\n"
            "they have a slightly lower range,\n"
            "a very low amount of health,\n"
            "and consume extremely high\n"
            "amounts of energy. Field strength\n"
            "dissipates rapidly if the shield\n"
            "loses power, and shields cannot\n"
            "regenerate any health.\n",

        "star cannon":
            "Launches projectiles at enemies\n"
            "to destroy them.\n"
            "\n"
            "The star cannon needs a bit of\n"
            "material for ammunition, as well\n"
            "as energy to propel it. Luckily,\n"
            "it will only attempt to consume\n"
            "resources when it detects enemies\n"
            "within attack range.\n"
            "\n"
            "Researchers across the galaxy are\n"
            "looking for destroyed enemies, in\n"
            "the interest of building stronger\n"
            "weapons against them. Thus, any\n"
            "enemies you destroy can be sold\n"
            "for starbits!\n",

        "storage":
            "Stores excess material, which it\n"
            "can transport to other structures\n"
            "later when needed.\n"
            "\n"
            "Storage structures are stronger\n"
            "than most other types of\n"
            "structures.\n"
            "\n"
            "When destroyed, it will attempt to\n"
            "store its stored material somewhere\n"
            "else, but any excess will be lost.\n"
            "\n"
            "Researching the storage structure\n"
            "may lead to the development of\n"
            "more useful structures...\n",

        "ultimate megastructure":
            "The mythical structure that your\n"
            "entire base was intended to build.\n"
            "\n"
            "The ultimate megastructure is the\n"
            "culmination of everything you have\n"
            "built, produced, and researched.\n"
            "\n"
            "Once this structure is finally\n"
            "built, you will unlock the secrets\n"
            "of the universe, and win the game!\n",
    }
...
class InfoPanel(Panel):
    ...
    def load(self, directory: str):
        ...
        self.write(TextInfo.files[directory.lower()].strip())
...
class Game:
    ...
    def display(self, current_menu: Menu) -> str:
        string: str = ""
        in_shop: bool = current_menu is Menu.SHOP or current_menu is Menu.SHOP_CONFIRM
        ...
        for index, card in enumerate(self.deck.cards):
            ...
            if current_menu is Menu.SELL or current_menu is Menu.SELL_CONFIRM:
                if (card.is_destroyed() or not card.is_enemy) and not card.is_core:
                    ...
                    value = "CORE"
            elif current_menu is Menu.UPGRADE or current_menu is Menu.UPGRADE_CONFIRM:
                if card.is_enemy:
                    value = "ENEMY"
